...
| 2026-07-18 | [update-board.dto.ts](file:///Users/s.vdovareize/work/api-me/src/alphadate/dto/update-board.dto.ts) | Need validation tests for board state updates (letters array and optional metadata). | Pending |
| 2026-07-18 | [alphadate.controller.ts](file:///Users/s.vdovareize/work/api-me/src/alphadate/alphadate.controller.ts) | Need unit tests for GET, PUT, and DELETE endpoints of board states (including manual validation checks for optional metadata and response objects). | Pending |
| 2026-07-18 | [alphadate.service.ts](file:///Users/s.vdovareize/work/api-me/src/alphadate/alphadate.service.ts) | Need unit tests for random `currentPartnerId` selection during board creation, and turn-taking transition logic, full-state resets, partner updates, and board deletion in `deleteBoard()`. | Pending |
